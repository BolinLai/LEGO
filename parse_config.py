"""
This file was copied from EgoVLP. It was only used for loading egovlp.pth in metric computing.
"""
...
# from metrics.egovlp.util import setup_logging
from metrics.egovlp.util import read_json, write_json
import time
import inspect
